...
1. **Zygisk not yet working (No ETA)**.
    ...
    Though, there might be a way to load su binaries as [kernel module when lxc session is starting](https://askubuntu.com/questions/314817/how-do-i-install-a-kernel-module-in-an-lxc-guest-machine#:~:text=You%20need%20a%20copy%20of,r)%22%20from%20the%20guest.&text=After%20that%2C%20shut%20down%20the,%2Dstart%20%2D%2Dname%20foo%22%20). Anybody who is well-versed in lxc can contact me/create issue to explain to me how to make it work.
